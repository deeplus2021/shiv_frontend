      ...
      <Formik
        ...
        onSubmit={async (values, actions) => {
          try {
            ...
            const opts = [props.id, values.iterations]

            // const opts = ['Education', 'Bhadrak', 'whatapp']

            const txExecute = api.tx.templateModule.drawJurors(...opts)
            ...
            <div className="text-center">
              ...
              <div className="form-group">
                ...
                {touched.iterations && errors.iterations && (
                  <p className="alert alert-danger">{errors.iterations}</p>
                )}

                <Field name="iterations" className="form-control" />
              </div>
              <button
                type="submit"
